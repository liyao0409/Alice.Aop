    ...
    internal class CallSiteFactory
    {
        ...
        private IServiceCallSite TryCreateExact(ServiceDescriptor descriptor, Type serviceType, CallSiteChain callSiteChain)
        {
            if (serviceType == descriptor.ServiceType)
            {
                ...
                {
                    Castle.DynamicProxy.IInterceptor[] interceptors=null;
                    var aliceDescriptor = descriptor as AliceServiceDescriptor;
                    if (aliceDescriptor != null)
                    {
                        interceptors = aliceDescriptor.Interceptors;
                    }
                    
                    callSite = new FactoryCallSite(descriptor.ServiceType, descriptor.ImplementationFactory,interceptors);
                }
                else if (descriptor.ImplementationType != null)
                {
                    ...
                    callSite = CreateConstructorCallSite(descriptor.ServiceType, descriptor.ImplementationType, callSiteChain,interceptors);
                }
                else
                {
        ...
        private IServiceCallSite TryCreateOpenGeneric(ServiceDescriptor descriptor, Type serviceType, CallSiteChain callSiteChain)
        {
                ...
                serviceType.GetGenericTypeDefinition() == descriptor.ServiceType)
            {
                ...
                var constructorCallSite = CreateConstructorCallSite(serviceType, closedType, callSiteChain,interceptors);
        ...
        private IServiceCallSite CreateConstructorCallSite(Type serviceType, 
            ...
            Castle.DynamicProxy.IInterceptor[] interceptors)
        {
            ...
            else if (constructors.Length == 1)
            {
                ...
                {
                    return new CreateInstanceCallSite(serviceType, implementationType, interceptors);
                }
                ...
                return new ConstructorCallSite(serviceType, constructor, parameterCallSites, interceptors);
            }
            ...
            else
            {
                ...
                return parameterCallSites.Length == 0 ?
                    (IServiceCallSite)new CreateInstanceCallSite(serviceType, implementationType,interceptors) :
                    new ConstructorCallSite(serviceType, bestConstructor, parameterCallSites, interceptors);
            }
        }
